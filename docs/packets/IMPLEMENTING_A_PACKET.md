...
3. **Wire** — register the writer/handler in `atlas-channel` and route the
   per-version opcode in all ten seed templates.
...
writer/handler glue, and route the opcode in all ten templates.
...
### Route in all ten seed templates

In each of `services/atlas-configurations/seed-data/templates/template_{gms_48,gms_61,gms_72,gms_79,gms_83,gms_84,gms_87,gms_92,gms_95,jms_185}_1.json`,
