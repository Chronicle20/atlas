...
| 5 | byte | byte `quick` | ✅ |  |
| 6 | string | string `message -- quick-send path only (CTabQuickSend::SendQuickDelivery @0x65c090); the NPC path (CTabSend::SendParcel @0x65d940) stops after the quick flag` | ✅ |  |
