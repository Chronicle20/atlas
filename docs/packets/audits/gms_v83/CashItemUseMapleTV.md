...
|---|---|---|---|---|
| 0 | (see byte-fixture) | `cases 46-51 (@0xa0d037-0xa0e556), one per tvType arm: tvType-conditional pad/ear/receiver prefix + 5xline(str), TRAILING update_time (updateTimeFirst=FALSE) — task-123 megaphone gap-fill pass.` | 🔍 | flat-diff-invalid: data-dependent branch — see byte-fixture test for the verified per-branch wire shape |
