...
| 2 | int32 | int32 `nDisassembledItemID @0x95dca1` | ✅ |  |
| 3 | int32 | int32 `nNumRewardItem @0x95dd0c (loop length prefix)` | ✅ |  |
| 4 | int32 | int32 `reward[i].nItemID @0x95dd25` | ✅ |  |
| 5 | int32 | int32 `reward[i].nCount @0x95dd32` | ✅ |  |
| 6 | int32 | int32 `nMesoCost @0x95dddb` | ✅ |  |
