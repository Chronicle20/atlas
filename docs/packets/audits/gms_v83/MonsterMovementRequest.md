...
| 9 | int16 | bytes `CMovePath::Flush body (Movement elements). v83 lacks the post-Flush bChasing/hasTarget/bChasing2/bChasingHack/tChaseDuration tail that v87+ carry.` | ❌ | width mismatch |
