...
**v83 IDA:** `CClientSocket::OnConnect` @ 0x494ed1 is **anti-tamper obfuscated**. StartError layout (Decode2 length + DecodeBuffer) is inferred from v95 @ 0x4aef10 which is consistent; this is the error-reporting path before any encryption context exists.
