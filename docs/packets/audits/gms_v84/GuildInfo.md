...
| 15 | int16 | string `` | ❌ | width mismatch |
| 16 | byte | string `` | ❌ | width mismatch |
| 17 | int16 | string `` | ❌ | width mismatch |
| 18 | byte | string `` | ❌ | width mismatch |
| 19 | string | int32 `` | ❌ | width mismatch |
| 20 | int32 | int32 `` | ✅ |  |
