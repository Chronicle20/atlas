...
| 3 | byte | byte `` | ✅ |  |
| 4 | int16 | int16 `` | ✅ |  |
| 5 | byte | byte `` | 🔍 | opaque type: model.Asset — register boundary (see opaque registry) |
| 6 | byte | unresolved `packet var passed to unresolved/indirect call; hand-trace` | ❌ | atlas: short — missing trailing field |
