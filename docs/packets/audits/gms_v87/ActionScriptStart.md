...
|---|---|---|---|---|
| 0 | int32 | int32 `npcId uint32 (Encode4 *(this+16) @0x75bfca)` | ✅ |  |
...
v87 vs v95/v83: gate confirmed ✅. `CQuest::StartQuest` @ 0x75bf04 (Encode1 action 4): Encode2(questId) + Encode4(npcId) + Encode2(x) + Encode2(y). Atlas matches.
