...
|---|---|---|---|---|
| 0 | byte | int32 `update_time = get_update_time() — common header, leading (task-124 v87: MajorVersion()>=87 updateTimeFirst; first version in the set to confirm this shape after v95)` | ❌ | width mismatch |
