...
| 2 | byte | bytes `AvatarLook::Decode (guard: v4 & 1)` | ❌ | width mismatch |
...
| 8 | int32 | bytes `liFriendshipItemSN (8) + liFriendshipPairItemSN (8) + dwFriendCharacterId (4)` | ❌ | width mismatch |
