...
| 1 | byte | byte `nCount (character entries in this world)` | ✅ |  |
| 2 | int32 | int32 `GW_CharacterStat::dwCharacterID` | ✅ |  |
...
| 8 | int64 | int64 `GW_CharacterStat::petLockerSN (DecodeBuffer 24 bytes = 3 × int64)` | ✅ |  |
...
| 15 | int16 | int16 `GW_CharacterStat::nHP (v87 still int16; v95 widened to int32)` | ✅ |  |
| 16 | int16 | int16 `GW_CharacterStat::nMHP (v87 still int16)` | ✅ |  |
| 17 | int16 | int16 `GW_CharacterStat::nMP (v87 still int16)` | ✅ |  |
| 18 | int16 | int16 `GW_CharacterStat::nMMP (v87 still int16)` | ✅ |  |
...
| 27 | int16 | int16 `GW_CharacterStat::nSubJob (present in v87)` | ✅ |  |
