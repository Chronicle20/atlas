...
| 3 | byte | int32 `v25 — extra 4-byte field decoded before GW_Friend::Insert (purpose unknown; possibly job/level)` | 🔍 | sub-struct: b — see _substruct/ |
| 4 | byte | int32 `v26 — extra 4-byte field decoded before GW_Friend::Insert (purpose unknown; possibly job/level)` | ❌ | width mismatch |
