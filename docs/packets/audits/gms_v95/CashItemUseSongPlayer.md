...
|---|---|---|---|---|
| 0 | int32 | int32 `update_time = get_update_time(); Encode4 in the SHARED HEADER, written FIRST (before nPOS/itemId) - definitively confirms updateTimeFirst=TRUE for gms_v95 @0x9eb4b7-0x9eb4c1` | ✅ |  |
| 1 | int32 | int16 `nPOS - Encode2 @0x9eb4ce-0x9eb4d2` | ❌ | width mismatch |
| 2 | byte | int32 `itemId - Encode4 @0x9eb4df-0x9eb4e3, then get_consume_cash_item_type(itemId) drives the type switch` | ❌ | atlas: short — missing trailing field |
