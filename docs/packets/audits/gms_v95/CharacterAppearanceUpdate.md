...
| 2 | byte | bytes `AvatarLook::Decode — full avatar look data (guard: v4 & 1)` | ✅ |  |
...
| 8 | int32 | bytes `liFriendshipItemSN (8 bytes) + liFriendshipPairItemSN (8 bytes) + dwFriendCharacterId (4 bytes)` | ✅ |  |
