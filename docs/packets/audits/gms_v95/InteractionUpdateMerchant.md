# InteractionUpdateMerchant (← `CPersonalShopDlg::OnRefresh#UpdateMerchant`)
...
> 🔍 tool limitation, NOT a wire bug. mode/meso/count ✅ (matches
> CEntrustedShopDlg::OnRefresh); per-item GW_ItemSlotBase loop is a sub-struct.
> See `docs/packets/ida-exports/_pending.md` → "Interaction tool-limitation false positives".
