...
| 1 | bytes | bytes `uFlagSet: 16-byte UINT128 stat mask (DecodeBuffer 0x10) — atlas: MonsterTemporaryStat.Encode mask` | ✅ |  |
| 2 | int16 | bytes `per-stat body via CMob::ProcessStatSet (variable-length, mask-dispatched)` | ✅ |  |
