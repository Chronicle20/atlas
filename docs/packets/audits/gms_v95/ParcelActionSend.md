...
| 5 | byte | byte `quick` | ✅ |  |
| 6 | string | string `message -- quick-send path only (CTabQuickSend::SendQuickDelivery @0x68fa00); the NPC path (CTabSend::SendParcel @0x690140) stops after the quick flag` | ✅ |  |
