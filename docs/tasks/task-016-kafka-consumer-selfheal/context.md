...
- Locally-run: atlas-channel, atlas-saga-orchestrator, atlas-npc-conversations (GoLand debug build of atlas-channel, per the startup log: `/home/tumidanski/.cache/JetBrains/GoLand2026.1/tmp/GoLand/___go_build_atlas_channel`).
