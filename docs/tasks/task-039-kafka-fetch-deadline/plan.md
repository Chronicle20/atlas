...
```bash
cd <home>/source/atlas-ms/atlas && go vet ./libs/atlas-kafka/... && go vet ./services/...
```
...
```bash
cd <home>/source/atlas-ms/atlas && docker build -f services/atlas-maps/Dockerfile -t atlas-maps:task-039 .
```
...
```bash
cd <home>/source/atlas-ms/atlas && docker build -f services/atlas-monsters/Dockerfile -t atlas-monsters:task-039 .
```
...
```bash
cd <home>/source/atlas-ms/atlas && docker build -f services/atlas-channel/Dockerfile -t atlas-channel:task-039 .
```
