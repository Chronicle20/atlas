...
```bash
cd /home/tumidanski/source/atlas-ms/atlas/.worktrees/task-061-data-cache-invalidation
...
**Files:**
- Modify: `/home/tumidanski/.claude/projects/-home-tumidanski-source-atlas-ms-atlas/memory/reference_atlas_maps_spawn_cache.md`

- [ ] **Step 1: Read the current note**

```bash
cat /home/tumidanski/.claude/projects/-home-tumidanski-source-atlas-ms-atlas/memory/reference_atlas_maps_spawn_cache.md
```
