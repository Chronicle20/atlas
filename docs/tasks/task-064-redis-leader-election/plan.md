...
**All paths are absolute under the worktree.** Working directory for every step: `<home>/source/atlas-ms/atlas/.worktrees/task-064-redis-leader-election/`.
...
```
cd <home>/source/atlas-ms/atlas/.worktrees/task-064-redis-leader-election
