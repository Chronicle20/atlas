...
| LOAD_GIFT_SUCCESS | OnCashItemResLoadGiftDone | item-blob | TBD-RE | TBD-RE | TBD-RE | TBD-RE | TBD-RE | TBD-RE | TBD-RE | 0x5A | TBD-RE | mode(disp); count:Decode2@0x496554 (uint16); giftList:DecodeBuffer(98×count)@0x49657d (COUNT-prefixed LIST of GW_GiftList — 98-byte blob, distinct from GW_CashItemInfo/CashInventoryItem; internal field layout NOT resolved here — stop-and-ask before modeling, needs its own decoder) |
