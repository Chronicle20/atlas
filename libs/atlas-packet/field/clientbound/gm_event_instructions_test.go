...
// packet-audit:verify packet=field/clientbound/FieldGmEventInstructions version=gms_v95 ida=0x5313d0
// packet-audit:verify packet=field/clientbound/FieldGmEventInstructions version=jms_v185 ida=0x5731fd
func TestGmEventInstructionsGolden(t *testing.T) {
...
func TestGmEventInstructionsRoundTrip(t *testing.T) {
	input := NewGmEventInstructions(0x02)
