...
// addresses below are cited in plain comments (not packet-audit:verify machine
// markers) because the audit-export evidence pipeline for this op is not part of
// this change — same matrix posture as the analogous CashShopOpen writer:
//
