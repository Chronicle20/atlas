...
// v48 is pinned by a byte fixture in operation_agreement_response_v48_test.go
// rather than by this round-trip, which only proves Encode and Decode agree with
// each other - not that either matches the client.
// packet-audit:verify packet=guild/serverbound/GuildAgreementResponse version=gms_v79 ida=0x51bc59
