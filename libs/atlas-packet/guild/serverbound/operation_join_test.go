...
// packet-audit:verify packet=guild/serverbound/GuildJoin version=gms_v79 ida=0x50e36f
// v72 CUIFadeYesNo::OnButtonClicked @0x50285e (case 7): COutPacket(124=GUILD_OPERATION)
// +Encode1(6=JOIN)+Encode4(guildId)+Encode4(characterId). Body = Encode4(guildId)+Encode4(characterId), == v79.
// packet-audit:verify packet=guild/serverbound/GuildJoin version=gms_v72 ida=0x50285e
