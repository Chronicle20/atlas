...
// v72 NPC shop list. CShopDlg::SetShopDlg@0x6a567e (GMS_v72.1_U_DEVM.exe, port
// 13339) reads Decode4 npcTemplateId, Decode2 count, then per item Decode4
...
// identical to the verified v79 read order: the discountRate/tokenTemplateId/
...
//
// packet-audit:verify packet=npc/clientbound/NpcShopList version=gms_v72 ida=0x6a567e
func TestNPCShopListV72(t *testing.T) {
	...
	if !bytes.Equal(got, want) {
		t.Fatalf("v72 ShopList: got % x, want % x", got, want)
	}
}
