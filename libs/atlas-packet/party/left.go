...
func NewLeft(mode byte, partyId uint32, targetId uint32, targetName string, forced bool, members []PartyMember, leaderId uint32) Left {
...
func (m Left) Members() []PartyMember { return m.members }
