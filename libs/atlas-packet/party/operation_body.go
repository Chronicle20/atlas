...
func PartyLeftBody(partyId uint32, targetId uint32, targetName string, members []PartyMember, leaderId uint32) func(logrus.FieldLogger, context.Context) func(map[string]interface{}) []byte {
...
func PartyExpelBody(partyId uint32, targetId uint32, targetName string, members []PartyMember, leaderId uint32) func(logrus.FieldLogger, context.Context) func(map[string]interface{}) []byte {
