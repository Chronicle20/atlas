...
func TestCreateAndEquipAssetPayload_UseAverageStats_RoundTrip(t *testing.T) {
	tests := []struct {
		...
		{name: "create and equip asset payload use average stats round trip"},
	}
...
func TestCharacterCreatePayload_GmAndMeso_RoundTrip(t *testing.T) {
	tests := []struct {
		...
		{name: "character create payload gm and meso round trip"},
	}
...
func TestUnmarshalAwaitInventoryCreatedStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal await inventory created step"},
	}
...
func TestUnmarshalEvolvePetStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal evolve pet step"},
	}
...
func TestUnmarshalTransferAPStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal transfer ap step"},
	}
...
func TestUnmarshalTransferSPStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal transfer sp step"},
	}
...
func TestUnmarshalTransferToMtsStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal transfer to mts step"},
	}
...
func TestUnmarshalWithdrawFromMtsStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal withdraw from mts step"},
	}
...
func TestUnmarshalAcceptToMtsListingStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal accept to mts listing step"},
	}
...
func TestUnmarshalReleaseFromMtsHoldingStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal release from mts holding step"},
	}
...
func TestUnmarshalMtsSettlePurchaseStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal mts settle purchase step"},
	}
...
func TestUnmarshalMtsMoveListingToHoldingStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal mts move listing to holding step"},
	}
...
func TestUnmarshalMtsBidEscrowStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal mts bid escrow step"},
	}
...
func TestUnmarshalTransferToParcelStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal transfer to parcel step"},
	}
...
func TestUnmarshalAcceptToParcelStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal accept to parcel step"},
	}
...
func TestUnmarshalReleaseFromParcelStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal release from parcel step"},
	}
...
func TestUnmarshalWithdrawFromParcelStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal withdraw from parcel step"},
	}
...
func TestUnmarshalShowParcelStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal show parcel step"},
	}
...
func TestUnmarshalShowParcelStep_Quick(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal show parcel step quick"},
	}
...
func TestUnmarshalAwaitInventoryCreatedStep_ZeroCharacterId(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal await inventory created step zero character id"},
	}
...
func TestUnmarshalStartRPSGameStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal start rps game step"},
	}
...
func TestUnmarshalSetAssetOwnerStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal set asset owner step"},
	}
...
func TestUnmarshalApplyAssetLockStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal apply asset lock step"},
	}
...
func TestUnmarshalIncubatorResultStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal incubator result step"},
	}
...
func TestUnmarshalDestroyAssetFromSlotTemplateId(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal destroy asset from slot template id"},
	}
...
func TestUnmarshalEmitMegaphoneStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal emit megaphone step"},
	}
...
func TestUnmarshalEnqueueWorldBroadcastStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal enqueue world broadcast step"},
	}
...
func TestCreateNoteStepUnmarshal(t *testing.T) {
	tests := []struct {
		...
		{name: "create note step unmarshal"},
	}
...
func TestUnmarshalTradeSettlement(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal trade settlement"},
	}
...
func TestUnmarshalAcceptToTradeStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal accept to trade step"},
	}
...
func TestUnmarshalReleaseFromTradeStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal release from trade step"},
	}
...
func TestUnmarshalTransferToTradeStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal transfer to trade step"},
	}
...
func TestUnmarshalStep_OpenNpcShop(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal step open npc shop"},
	}
...
func TestUnmarshalExtendAssetExpirationStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal extend asset expiration step"},
	}
...
func TestExpirationExtenderUseSagaTypeValue(t *testing.T) {
	tests := []struct {
		...
		{name: "expiration extender use saga type value"},
	}
...
func TestPetReviveSagaTypeValue(t *testing.T) {
	tests := []struct {
		...
		{name: "pet revive saga type value"},
	}
...
func TestUnmarshalRevivePetPayload(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal revive pet payload"},
	}
...
func TestUnmarshalStartItemConversationPayload(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal start item conversation payload"},
	}
...
func TestUnmarshalStartNpcConversationPayload(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal start npc conversation payload"},
	}
...
func TestUnmarshalPlayJukeboxStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal play jukebox step"},
	}
...
func TestUnmarshalClearSkillStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal clear skill step"},
	}
...
func TestUnmarshalWarpToMapStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal warp to map step"},
	}
...
func TestUnmarshalPlaySoundStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal play sound step"},
	}
...
func TestUnmarshalChangeMusicStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal change music step"},
	}
...
func TestUnmarshalBoatEffectStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal boat effect step"},
	}
...
func TestUnmarshalExplorerQuestStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal explorer quest step"},
	}
...
func TestUnmarshalClearDropsStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal clear drops step"},
	}
...
func TestUnmarshalResetReactorsStepWithoutMinState(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal reset reactors step without min state"},
	}
...
func TestUnmarshalResetReactorsStepWithMinState(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal reset reactors step with min state"},
	}
...
func TestUnmarshalShuffleReactorsStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal shuffle reactors step"},
	}
...
func TestUnmarshalResetFieldStep(t *testing.T) {
	tests := []struct {
		...
		{name: "unmarshal reset field step"},
	}
