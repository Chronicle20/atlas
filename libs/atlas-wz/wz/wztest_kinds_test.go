...
func TestBuilderEmitsAllPropertyKinds(t *testing.T) {
	...
	tests := []struct {
		...
		{"string", func(t *testing.T, props []property.Property) {
		...
		{"vector", func(t *testing.T, props []property.Property) {
