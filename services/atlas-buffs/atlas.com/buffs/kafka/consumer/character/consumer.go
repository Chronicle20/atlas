...
func handleApply(l logrus.FieldLogger, ctx context.Context, c character2.Command[character2.ApplyCommandBody]) {
	...
	if err := character.NewProcessor(l, ctx).Apply(c.WorldId, c.ChannelId, c.CharacterId, c.Body.FromId, c.Body.SourceId, c.Body.Level, c.Body.Duration, statChanges); err != nil {
