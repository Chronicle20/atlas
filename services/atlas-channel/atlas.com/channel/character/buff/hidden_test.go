...
func TestIsGmHidden_v48Wire(t *testing.T) {
	...
	hideV48 := NewBuff(5101004, 1, math.MaxInt32, nil, time.Now(), future)
	...
	canonicalUnderV48 := NewBuff(int32(skill2.SuperGmHideId), 1, math.MaxInt32, nil, time.Now(), future)
...
func TestIsGmHidden_v72CorkscrewNotHidden(t *testing.T) {
	...
	corkscrewV72 := NewBuff(5101004, 1, 1000, nil, time.Now(), future)
