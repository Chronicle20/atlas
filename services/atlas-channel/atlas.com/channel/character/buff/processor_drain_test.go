...
func buffDoc(from, to int, total, number, size, last int) string {
	...
	for id := from; id <= to; id++ {
		...
		b.WriteString(fmt.Sprintf(
			`{"id":"%d","type":"buffs","attributes":{"sourceId":%d,"level":1,"duration":60000,"changes":[],"createdAt":"2024-01-01T00:00:00Z","expiresAt":"2024-01-01T01:00:00Z"}}`,
			id, id,
		))
	}
	return fmt.Sprintf(
...
// picks up buff sourceId 300, which lives on page 2.
