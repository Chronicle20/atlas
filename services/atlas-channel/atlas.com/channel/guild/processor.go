...
type Processor interface {
	...
	GetMemberIds(guildId uint32, filters []model.Filter[member.Model]) model.Provider[[]uint32]
	RequestCreate(f field.Model, characterId uint32, name string) error
	CreationAgreement(characterId uint32, agreed bool) error
	RequestEmblemUpdate(guildId uint32, characterId uint32, logoBackground uint16, logoBackgroundColor byte, logo uint16, logoColor byte) error
	RequestNoticeUpdate(guildId uint32, characterId uint32, notice string) error
	Leave(guildId uint32, characterId uint32) error
	Expel(guildId uint32, characterId uint32, targetId uint32, targetName string) error
	RequestInvite(guildId uint32, characterId uint32, targetId uint32) error
	RequestTitleChanges(guildId uint32, characterId uint32, titles []string) error
	RequestMemberTitleUpdate(guildId uint32, characterId uint32, targetId uint32, newTitle byte) error
}
...
func (p *ProcessorImpl) GetMemberIds(guildId uint32, filters []model.Filter[member.Model]) model.Provider[[]uint32] {
...
func (p *ProcessorImpl) RequestCreate(f field.Model, characterId uint32, name string) error {
...
func (p *ProcessorImpl) CreationAgreement(characterId uint32, agreed bool) error {
...
func (p *ProcessorImpl) RequestEmblemUpdate(guildId uint32, characterId uint32, logoBackground uint16, logoBackgroundColor byte, logo uint16, logoColor byte) error {
...
func (p *ProcessorImpl) RequestNoticeUpdate(guildId uint32, characterId uint32, notice string) error {
...
func (p *ProcessorImpl) Leave(guildId uint32, characterId uint32) error {
...
func (p *ProcessorImpl) Expel(guildId uint32, characterId uint32, targetId uint32, targetName string) error {
...
func (p *ProcessorImpl) RequestTitleChanges(guildId uint32, characterId uint32, titles []string) error {
...
func (p *ProcessorImpl) RequestMemberTitleUpdate(guildId uint32, characterId uint32, targetId uint32, newTitle byte) error {
