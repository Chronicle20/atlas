...
func InitConsumers(l logrus.FieldLogger) func(func(config consumer.Config, decorators ...model.Decorator[consumer.Config])) func(consumerGroupId string) {
	return func(rf func(config consumer.Config, decorators ...model.Decorator[consumer.Config])) func(consumerGroupId string) {
		return func(consumerGroupId string) {
			rf(consumer2.NewConfig(l)("guild_command")(guild2.EnvCommandTopic)(consumerGroupId), consumer.SetHeaderParsers(consumer.SpanHeaderParser, consumer.TenantHeaderParser, consumer.EnvHeaderParser), consumer.SetStartOffset(kafka.LastOffset))
			rf(consumer2.NewConfig(l)("guild_status_event")(guild2.EnvStatusEventTopic)(consumerGroupId), consumer.SetHeaderParsers(consumer.SpanHeaderParser, consumer.TenantHeaderParser, consumer.EnvHeaderParser), consumer.SetStartOffset(kafka.LastOffset))
		}
	}
}
...
func handleRequestAgreement(sc server.Model, wp writer.Producer) message.Handler[guild2.StatusEvent[guild2.StatusEventRequestAgreementBody]] {
	return func(l logrus.FieldLogger, ctx context.Context, e guild2.StatusEvent[guild2.StatusEventRequestAgreementBody]) {
		...
		if err != nil {
			err = session.NewProcessor(l, ctx).IfPresentByCharacterId(sc.Channel())(e.Body.ActorId, announceGuildError(l)(ctx)(wp)(guildpkt.GuildOperationCreateError))
			if err != nil {
				l.Debugf("Unable to issue character [%d] guild error [%s].", e.Body.ActorId, err)
			}
			return
