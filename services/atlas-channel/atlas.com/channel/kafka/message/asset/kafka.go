...
// AssetData is a full point-in-time asset snapshot, matching the shape carried
// by CreatedStatusEventBody/UpdatedStatusEventBody/AcceptedStatusEventBody
// above. It is embedded by other kafka message packages (e.g.
// kafka/message/merchant) that need to hand a downstream service the complete
// asset state at command time, mirroring atlas-merchant's own
// kafka/message/asset.AssetData.
