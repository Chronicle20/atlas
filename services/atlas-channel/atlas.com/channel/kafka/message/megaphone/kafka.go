...
// kafka/message/worldbroadcast), these tiers are not queued - atlas-channel
// consumes this event and renders the broadcast to the target scope
// (channel or world) immediately.
//
// Mirrors atlas-saga-orchestrator's kafka/message/megaphone/kafka.go
// (task-123 Task 10) byte-for-byte: same field set, same json tags, same
// EnvEventTopicMegaphone value.
