...
type ProcessorMock struct {
	...
	KillFunc                   func(f field.Model, monsterId uint32, characterId uint32, skillId uint32) error
}
...
func (m *ProcessorMock) Kill(f field.Model, monsterId uint32, characterId uint32, skillId uint32) error {
	if m.KillFunc != nil {
		return m.KillFunc(f, monsterId, characterId, skillId)
	}
	return nil
}
