...
type Processor interface {
	...
	InMapRectModelProvider(f field.Model, x1, y1, x2, y2 int16, limit uint32) model.Provider[[]Model]
	GetInMapRect(f field.Model, x1, y1, x2, y2 int16, limit uint32) ([]Model, error)
	Damage(f field.Model, monsterId uint32, characterId uint32, damages []uint32, attackType byte) error
	EmitDamageReflected(f field.Model, uniqueId uint32, templateId uint32, characterId uint32, reflectDamage uint32, reflectType string) error
	UseSkill(f field.Model, monsterId uint32, characterId uint32, skillId byte, skillLevel byte) error
	UseBasicAttack(f field.Model, monsterId uint32, attackPos uint8) error
	ApplyStatus(f field.Model, monsterId uint32, characterId uint32, skillId uint32, skillLevel uint32, statuses map[string]int32, duration uint32) error
...
func (p *ProcessorImpl) GetInMapRect(f field.Model, x1, y1, x2, y2 int16, limit uint32) ([]Model, error) {
	return p.InMapRectModelProvider(f, x1, y1, x2, y2, limit)()
}

func (p *ProcessorImpl) Damage(f field.Model, monsterId uint32, characterId uint32, damages []uint32, attackType byte) error {
...
func (p *ProcessorImpl) EmitDamageReflected(f field.Model, uniqueId uint32, templateId uint32, characterId uint32, reflectDamage uint32, reflectType string) error {
...
func (p *ProcessorImpl) UseSkill(f field.Model, monsterId uint32, characterId uint32, skillId byte, skillLevel byte) error {
...
func (p *ProcessorImpl) UseBasicAttack(f field.Model, monsterId uint32, attackPos uint8) error {
...
func (p *ProcessorImpl) ApplyStatus(f field.Model, monsterId uint32, characterId uint32, skillId uint32, skillLevel uint32, statuses map[string]int32, duration uint32) error {
...
func (p *ProcessorImpl) DamageFriendly(f field.Model, attackedUniqueId uint32, observerUniqueId, attackerUniqueId uint32) error {
...
func (p *ProcessorImpl) CancelStatus(f field.Model, monsterId uint32, statusTypes []string, sourceCharacterId uint32, sourceSkillId uint32, sourceSkillClass string) error {
