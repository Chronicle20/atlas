...
func IncMobChargeCountBody(uniqueId uint32, chargeCount int32, attackReady int32) packet.Encode {
	return func(l logrus.FieldLogger, ctx context.Context) func(options map[string]interface{}) []byte {
		return func(options map[string]interface{}) []byte {
			return monsterpkt.NewIncMobChargeCount(uniqueId, chargeCount, attackReady).Encode(l, ctx)(options)
		}
	}
}
