...
// block and pushes the CITC stage so the in-game MTS view opens. The trailing
// server-now FILETIME seeds the client's ITC clock (m_ftRel) so auction
// countdowns are correct — see the SetItcWriter doc.
