...
type ProcessorMock struct {
	...
	AllProviderFunc                func() model.Provider[[]templates.RestModel]
	GetAllFunc                     func() ([]templates.RestModel, error)
...
func (m *ProcessorMock) AllProvider() model.Provider[[]templates.RestModel] {
...
func (m *ProcessorMock) GetAll() ([]templates.RestModel, error) {
	if m.GetAllFunc != nil {
		return m.GetAllFunc()
	}
	return nil, nil
