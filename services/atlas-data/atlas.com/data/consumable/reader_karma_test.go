...
// karmaTestXML mirrors the shipped v83 layout: 02280000 is one of the
// mastery books (Item.wz/Consume/0228.img), the other v83 corpus carrier of
// info/tradeAvailable besides equipment.
const karmaTestXML = `
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<imgdir name="0228.img">
  <imgdir name="02280000">
    <imgdir name="info">
      <int name="tradeBlock" value="1"/>
      <int name="tradeAvailable" value="1"/>
    </imgdir>
  </imgdir>
  <imgdir name="02280001">
    <imgdir name="info">
      <int name="tradeBlock" value="1"/>
    </imgdir>
  </imgdir>
...
func TestReaderTradeAvailablePresent(t *testing.T) {
	...
	if res[0].Id != 2280000 {
		t.Fatalf("Id = %d, want 2280000", res[0].Id)
	}
