		...
		return func(db *gorm.DB) func(name string, path string) error {
			return func(name string, path string) error {
				...
				if name == WorkerMap {
					...
					err = RegisterAllData(l)(ctx)(path, filepath.Join("Map.wz", "Map"), func(l logrus.FieldLogger) func(ctx context.Context) func(filePath string) error {
						return func(ctx context.Context) func(filePath string) error {
							return func(filePath string) error {
								return _map.NewProcessor(l, ctx, db).RegisterMap(filePath)
							}
						}
					})()
					...
					err = RegisterAllData(l)(ctx)(path, filepath.Join("Item.wz", "Consume"), func(l logrus.FieldLogger) func(ctx context.Context) func(filePath string) error {
						return func(ctx context.Context) func(filePath string) error {
							return func(filePath string) error {
								return consumable.NewProcessor(l, ctx, db).RegisterConsumable(filePath)
							}
						}
					})()
					...
					err = RegisterAllData(l)(ctx)(path, filepath.Join("Character.wz", "Hair"), func(l logrus.FieldLogger) func(ctx context.Context) func(filePath string) error {
						return func(ctx context.Context) func(filePath string) error {
							return func(filePath string) error {
								return hair.NewProcessor(l, ctx, db).RegisterHair(filePath)
							}
						}
					})()
