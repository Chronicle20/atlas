...
#### Reactor
Represents reactor data with bounding box (TL, BR), state info mapping state IDs to reactor states, and timeout info.
...
Processors include:
- `cash.RegisterCash`
- `templates.RegisterTemplate` (character templates)
