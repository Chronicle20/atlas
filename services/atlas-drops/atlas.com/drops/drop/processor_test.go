...
func TestProcessor_Reserve_MesoDrop_SplitsAmongCoLocatedPartyMembers(t *testing.T) {
	setupProcessorTestRegistry(t)
	ctx, ten := createTestContext(t)
	l := createTestLogger()
...
func TestProcessor_Reserve_MesoDrop_ExcludesMembersNotCoLocated(t *testing.T) {
	setupProcessorTestRegistry(t)
	ctx, ten := createTestContext(t)
	l := createTestLogger()
...
func TestProcessor_Reserve_ItemDrop_MakesNoPartyLookup(t *testing.T) {
	setupProcessorTestRegistry(t)
	ctx, ten := createTestContext(t)
	l := createTestLogger()
...
func TestProcessor_Reserve_PartyLookupError_AwardsFullAmountToPicker(t *testing.T) {
	setupProcessorTestRegistry(t)
	ctx, ten := createTestContext(t)
	l := createTestLogger()
...
func TestProcessor_Reserve_FailedReservation_EmitsNoAwards(t *testing.T) {
	setupProcessorTestRegistry(t)
	ctx, ten := createTestContext(t)
	l := createTestLogger()
...
func TestProcessor_Reserve_ZeroShareSuppressesNonPickersOnly(t *testing.T) {
	setupProcessorTestRegistry(t)
	ctx, ten := createTestContext(t)
	l := createTestLogger()
