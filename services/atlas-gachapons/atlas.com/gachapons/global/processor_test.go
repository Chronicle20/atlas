...
func seedCountItem(t *testing.T, p global.Processor, tenantId uuid.UUID, itemId uint32) {
	t.Helper()
...
func TestProcessorImpl_Count_Empty(t *testing.T) {
	...
	p := global.NewProcessor(l, ctx, db)
...
func TestProcessorImpl_Count_Populated(t *testing.T) {
	...
	p := global.NewProcessor(l, ctx, db)
	seedCountItem(t, p, te.Id(), 2000000)
	seedCountItem(t, p, te.Id(), 2000001)
	seedCountItem(t, p, te.Id(), 2000002)
	...
	// global_gachapon_items has no updated_at column; updatedAt must be nil.
	if updated != nil {
...
func TestProcessorImpl_Count_TenantIsolation(t *testing.T) {
	...
	p1 := global.NewProcessor(l, ctx1, db)
	p2 := global.NewProcessor(l, ctx2, db)

	// Tenant 1: 2 rows
	seedCountItem(t, p1, te1.Id(), 3000000)
	seedCountItem(t, p1, te1.Id(), 3000001)
	// Tenant 2: 3 rows
	seedCountItem(t, p2, te2.Id(), 3000002)
	seedCountItem(t, p2, te2.Id(), 3000003)
	seedCountItem(t, p2, te2.Id(), 3000004)
