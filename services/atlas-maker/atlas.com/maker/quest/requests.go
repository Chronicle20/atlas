...
// characterQuestsUrl returns the list URL for a character's quests. It is a
// bare URL (not a requests.Request) because the list is paginated
...
func characterQuestsUrl(ctx context.Context, characterId uint32) (string, error) {
