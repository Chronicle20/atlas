...
func updateMapScript(db *gorm.DB) func(id uuid.UUID) func(m MapScript) (MapScript, error) {
...
func deleteMapScript(db *gorm.DB) func(id uuid.UUID) error {
...
func deleteAllMapScripts(db *gorm.DB) (int64, error) {
