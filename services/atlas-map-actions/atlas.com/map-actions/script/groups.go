	...
	return func(db *gorm.DB) server.RouteInitializer {
		return func(router *mux.Router, l logrus.FieldLogger) {
			...
			seeder.RegisterRoutes(router, db, l, src, seeder.Group{
				Name:      "map-actions",
				URLPrefix: "/maps/actions",
				Subdomains: []seeder.SubdomainAny{
					seeder.AdaptSubdomain[jsonMapScript, MapScript](OnUserEnterSubdomain{}),
					seeder.AdaptSubdomain[jsonMapScript, MapScript](OnFirstUserEnterSubdomain{}),
				},
			})
		}
	}
