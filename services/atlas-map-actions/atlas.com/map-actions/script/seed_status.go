...
func (r SeedStatusRestModel) GetName() string                                   { return "mapActionScriptsSeedStatus" }
...
// SeedStatusHandler handles GET /maps/actions/seed/status
func SeedStatusHandler(d *rest.HandlerDependency, c *rest.HandlerContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			l.WithError(err).Errorf("Unable to read map action scripts seed status.")
