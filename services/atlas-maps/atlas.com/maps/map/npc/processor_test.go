...
func TestCreateNpcInField(t *testing.T) {
	tests := []struct {
		...
		{name: "creates npc and returns it in the field"},
	}
...
func TestCreateNpcSpawnIfAbsentSuppressesWhenPresent(t *testing.T) {
	tests := []struct {
		...
		{name: "SpawnIfAbsent suppresses a duplicate spawn in the same field"},
	}
...
func TestCreateNpcSpawnIfAbsentIsFieldScoped(t *testing.T) {
	tests := []struct {
		...
		{name: "SpawnIfAbsent suppression does not cross field instances"},
	}
...
func TestCreateNpcWithoutGuardStacks(t *testing.T) {
	tests := []struct {
		...
		{name: "repeated create without SpawnIfAbsent stacks npcs"},
	}
...
func TestCreateNpcEmitsCreatedStatusEvent(t *testing.T) {
	tests := []struct {
		...
		{name: "Create emits one CREATED status event"},
	}
...
func TestCreateNpcSpawnIfAbsentSuppressedEmitsNothing(t *testing.T) {
	tests := []struct {
		...
		{name: "suppressed create emits no status event"},
	}
