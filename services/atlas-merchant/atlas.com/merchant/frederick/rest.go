...
// TransformStatus builds the REST resource for a character's Fredrick standing.
func TransformStatus(characterId uint32, hasPending bool) (StatusRestModel, error) {
	return StatusRestModel{
