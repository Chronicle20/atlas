...
func InitConsumers(l logrus.FieldLogger) func(func(config consumer.Config, decorators ...model.Decorator[consumer.Config])) func(consumerGroupId string) {
	return func(rf func(config consumer.Config, decorators ...model.Decorator[consumer.Config])) func(consumerGroupId string) {
		return func(consumerGroupId string) {
			rf(consumer2.NewConfig(l)("messenger_command")(messageMessenger.EnvCommandTopic)(consumerGroupId), consumer.SetHeaderParsers(consumer.SpanHeaderParser, consumer.TenantHeaderParser, consumer.EnvHeaderParser))
		}
	}
}
...
func InitHandlers(l logrus.FieldLogger) func(rf func(topic string, handler handler.Handler) (string, error)) error {
	return func(rf func(topic string, handler handler.Handler) (string, error)) error {
		var t string
		var err error
		t, err = topic.EnvProvider(l)(messageMessenger.EnvCommandTopic)()
		if err != nil {
			return err
		}
...
func handleCreate(l logrus.FieldLogger, ctx context.Context, c messageMessenger.CommandEvent[messageMessenger.CreateCommandBody]) {
	...
	_, err := messenger.CreateAndEmit(l)(ctx)(messenger.CreateInput{
		TransactionID: c.TransactionID,
		CharacterId:   c.ActorId,
	})
	if err != nil {
...
func handleJoin(l logrus.FieldLogger, ctx context.Context, c messageMessenger.CommandEvent[messageMessenger.JoinCommandBody]) {
	...
	_, err := messenger.JoinAndEmit(l)(ctx)(messenger.JoinInput{
		TransactionID: c.TransactionID,
		MessengerId:   c.Body.MessengerId,
		CharacterId:   c.ActorId,
	})
	if err != nil {
...
func handleLeave(l logrus.FieldLogger, ctx context.Context, c messageMessenger.CommandEvent[messageMessenger.LeaveCommandBody]) {
	...
	_, err := messenger.LeaveAndEmit(l)(ctx)(messenger.LeaveInput{
		TransactionID: c.TransactionID,
		MessengerId:   c.Body.MessengerId,
		CharacterId:   c.ActorId,
	})
...
func handleRequestInvite(l logrus.FieldLogger, ctx context.Context, c messageMessenger.CommandEvent[messageMessenger.RequestInviteBody]) {
	...
	err := messenger.RequestInviteAndEmit(l)(ctx)(messenger.RequestInviteInput{
		TransactionID: c.TransactionID,
		ActorId:       c.ActorId,
