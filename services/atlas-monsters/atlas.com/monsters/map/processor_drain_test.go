...
// TestCharacterIdsInFieldProviderDrainsBeyondOnePage proves
// CharacterIdsInFieldProvider (via requests.DrainProvider) fetches every
...
// paginated (task-117); this consumer needs the complete set for monster
// AI targeting/aggro -- the fixture server serves 300 characters across two
// pages of 250, so only a genuine drain picks up character id 300, which
// lives on page 2.
func TestCharacterIdsInFieldProviderDrainsBeyondOnePage(t *testing.T) {
