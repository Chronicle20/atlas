...
// TestStatusEventEnvelopeEchoesProvenance and
// TestStatusEventEnvelopeOmitsEmptyProvenance cover task-231's widening of
// the shared statusEvent envelope constructor to echo the monster's spawn
// provenance (spawnSourceType / spawnSourceId) on every status event type.
