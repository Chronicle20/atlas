...
| Method | Description |
|--------|-------------|
| Create | Creates a note and buffers a CREATED status event |
| CreateAndEmit | Creates a note and emits a CREATED status event |
| Update | Updates a note and buffers an UPDATED status event |
| UpdateAndEmit | Updates a note and emits an UPDATED status event |
| Delete | Deletes a note and buffers a DELETED status event |
| DeleteAndEmit | Deletes a note and emits a DELETED status event |
| DeleteAll | Deletes all notes for a character and buffers DELETED status events |
...
Creates saga commands for cross-service coordination.

| Method | Description |
|--------|-------------|
| Create | Produces a saga command to the saga topic |
