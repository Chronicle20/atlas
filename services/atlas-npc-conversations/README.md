...
- **Kafka** — Receives conversation commands (start, continue, end) and character/saga status events. Produces NPC dialogue commands, character status events, and saga commands.
...
| SEED_CATALOG_ROOT                | Filesystem root for NPC/quest conversation seed catalogs (default: ./deploy/seed) |
