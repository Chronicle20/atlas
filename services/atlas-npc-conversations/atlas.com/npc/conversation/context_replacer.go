...
func ReplaceContextPlaceholders(text string, context map[string]string) (string, error) {
...
func ExtractContextValue(input string, context map[string]string) (string, bool, error) {
