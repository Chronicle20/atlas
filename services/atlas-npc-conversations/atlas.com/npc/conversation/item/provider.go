...
// getByIdProvider returns a provider for retrieving an item conversation by ID
...
// getByItemIdProvider returns a provider for retrieving an item conversation by item ID
...
// getAllPagedProvider returns a provider for retrieving one page of item
