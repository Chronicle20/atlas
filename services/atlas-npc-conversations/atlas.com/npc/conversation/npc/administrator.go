...
func updateNpcConversation(db *gorm.DB) func(id uuid.UUID) func(m Model) (Model, error) {
...
func deleteNpcConversation(db *gorm.DB) func(id uuid.UUID) error {
...
func deleteAllNpcConversations(db *gorm.DB) (int64, error) {
