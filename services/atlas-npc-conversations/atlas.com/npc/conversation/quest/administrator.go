...
func updateQuestConversation(db *gorm.DB) func(tenantId uuid.UUID) func(id uuid.UUID) func(m Model) (Model, error) {
...
func deleteQuestConversation(db *gorm.DB) func(tenantId uuid.UUID) func(id uuid.UUID) error {
...
func deleteAllQuestConversations(db *gorm.DB) func(tenantId uuid.UUID) (int64, error) {
