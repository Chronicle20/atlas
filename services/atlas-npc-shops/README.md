...
The service maintains an in-memory registry of characters currently browsing shops and automatically removes characters when they log out, change maps, or change channels. A per-tenant consumable cache avoids repeated REST calls to the data service for rechargeable item metadata.
