...
// AssetData is a jsonb snapshot of an asset's state at the moment it was
// handed to Duey for custody. Copied verbatim from
// services/atlas-merchant/atlas.com/merchant/kafka/message/asset/kafka.go —
// a straightforward move, not a cross-service import (see CLAUDE.md).
