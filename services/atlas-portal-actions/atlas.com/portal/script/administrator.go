...
func updatePortalScript(db *gorm.DB) func(tenantId uuid.UUID) func(id uuid.UUID) func(m PortalScript) (PortalScript, error) {
	return func(tenantId uuid.UUID) func(id uuid.UUID) func(m PortalScript) (PortalScript, error) {
		return func(id uuid.UUID) func(m PortalScript) (PortalScript, error) {
			return func(m PortalScript) (PortalScript, error) {
...
func deletePortalScript(db *gorm.DB) func(tenantId uuid.UUID) func(id uuid.UUID) error {
...
func deleteAllPortalScripts(db *gorm.DB) func(tenantId uuid.UUID) (int64, error) {
