...
func InitResource(si jsonapi.ServerInformation) func(db *gorm.DB) server.RouteInitializer {
	return func(db *gorm.DB) server.RouteInitializer {
		return func(router *mux.Router, l logrus.FieldLogger) {
			...
			// Register handlers
			router.HandleFunc("/portals/scripts", registerHandler("get_all_scripts", GetAllScriptsHandler)).Methods(http.MethodGet)
			router.HandleFunc("/portals/scripts/{scriptId}", registerHandler("get_script", GetScriptHandler)).Methods(http.MethodGet)
			router.HandleFunc("/portals/{portalId}/scripts", registerHandler("get_scripts_by_portal", GetScriptsByPortalHandler)).Methods(http.MethodGet)
...
func GetScriptsByPortalHandler(d *rest.HandlerDependency, c *rest.HandlerContext) http.HandlerFunc {
