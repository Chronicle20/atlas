...
func (r SeedStatusRestModel) GetName() string                                   { return "portalScriptsSeedStatus" }
...
// SeedStatusHandler handles GET /portals/scripts/seed/status
func SeedStatusHandler(d *rest.HandlerDependency, c *rest.HandlerContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			l.WithError(err).Errorf("Unable to read portal scripts seed status.")
