...
func (b *Builder) SetReborns(v uint32) *Builder            { b.reborns = v; return b }
func (b *Builder) SetDojoPoints(v uint32) *Builder         { b.dojoPoints = v; return b }
func (b *Builder) SetVanquisherKills(v uint32) *Builder    { b.vanquisherKills = v; return b }
