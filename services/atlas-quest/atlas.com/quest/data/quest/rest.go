...
type RequirementsRestModel struct {
	...
	DayByDay        bool               `json:"dayByDay,omitempty"`
	DayOfWeek       []string           `json:"dayOfWeek,omitempty"`
	Start           string             `json:"start,omitempty"`
	End             string             `json:"end,omitempty"`
	Interval        uint32             `json:"interval,omitempty"` // Minutes since last completion
...
type ActionsRestModel struct {
	...
	NextQuest  uint32        `json:"nextQuest,omitempty"` // Next quest in chain
