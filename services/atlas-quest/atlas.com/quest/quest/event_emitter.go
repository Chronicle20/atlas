...
type EventEmitter interface {
	EmitQuestStarted(transactionId uuid.UUID, characterId uint32, worldId byte, questId uint32) error
	EmitQuestCompleted(transactionId uuid.UUID, characterId uint32, worldId byte, questId uint32) error
...
func (e *KafkaEventEmitter) EmitQuestStarted(transactionId uuid.UUID, characterId uint32, worldId byte, questId uint32) error {
	return questproducer.EmitQuestStarted(e.l, e.ctx, transactionId, characterId, worldId, questId)
}

func (e *KafkaEventEmitter) EmitQuestCompleted(transactionId uuid.UUID, characterId uint32, worldId byte, questId uint32) error {
	return questproducer.EmitQuestCompleted(e.l, e.ctx, transactionId, characterId, worldId, questId)
}
