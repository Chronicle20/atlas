...
// on page 2. GetEquippedAssets/GetCashAssets must see every asset in the
// compartment, or a truncated first-page-only fetch would silently drop
// equipped/cash items past the 250th slot.
