...
func ComputePlaytimeSince(l logrus.FieldLogger) func(ctx context.Context) func(characterId uint32, since time.Time) (time.Duration, error) {
	return func(ctx context.Context) func(characterId uint32, since time.Time) (time.Duration, error) {
		return func(characterId uint32, since time.Time) (time.Duration, error) {
