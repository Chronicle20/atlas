...
type Processor interface {
	...
	BlockAndEmit(characterId uint32, mapId uint32, portalId uint32) error
	// Block adds a block command to the message buffer
	Block(mb *message.Buffer) func(characterId uint32, mapId uint32, portalId uint32) error
	// UnblockAndEmit sends a command to unblock a portal for a character
	UnblockAndEmit(characterId uint32, mapId uint32, portalId uint32) error
	// Unblock adds an unblock command to the message buffer
	Unblock(mb *message.Buffer) func(characterId uint32, mapId uint32, portalId uint32) error
}
...
func (p *ProcessorImpl) BlockAndEmit(characterId uint32, mapId uint32, portalId uint32) error {
...
// Block adds a block command to the message buffer
func (p *ProcessorImpl) Block(mb *message.Buffer) func(characterId uint32, mapId uint32, portalId uint32) error {
	return func(characterId uint32, mapId uint32, portalId uint32) error {
...
func (p *ProcessorImpl) UnblockAndEmit(characterId uint32, mapId uint32, portalId uint32) error {
	return message.Emit(p.p)(func(mb *message.Buffer) error {
...
// Unblock adds an unblock command to the message buffer
func (p *ProcessorImpl) Unblock(mb *message.Buffer) func(characterId uint32, mapId uint32, portalId uint32) error {
	return func(characterId uint32, mapId uint32, portalId uint32) error {
