...
func BlockCommandProvider(characterId uint32, mapId uint32, portalId uint32) model.Provider[[]kafka.Message] {
...
func UnblockCommandProvider(characterId uint32, mapId uint32, portalId uint32) model.Provider[[]kafka.Message] {
	key := producer.CreateKey(int(characterId))
