...
var allActions = []sharedsaga.Action{
	...
	sharedsaga.UpdateAreaInfo, sharedsaga.ShowInfo, sharedsaga.PlaySound, sharedsaga.ShowInfoText, sharedsaga.ShowIntro,
	sharedsaga.ShowHint, sharedsaga.ShowGuideHint, sharedsaga.BlockPortal, sharedsaga.UnblockPortal,
	sharedsaga.ChangeMusic, sharedsaga.BoatEffect,
	sharedsaga.SpawnMonster, sharedsaga.SpawnReactorDrops, sharedsaga.SpawnNpc, sharedsaga.DeployPlayerNpc,
	sharedsaga.ClearDrops, sharedsaga.ResetReactors, sharedsaga.ShuffleReactors, sharedsaga.ResetField,
