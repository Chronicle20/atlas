...
func SendMessageCommandProvider(transactionId uuid.UUID, ch channel.Model, characterId uint32, messageType string, message string) model.Provider[[]kafka.Message] {
...
func PlayPortalSoundCommandProvider(transactionId uuid.UUID, ch channel.Model, characterId uint32) model.Provider[[]kafka.Message] {
	key := producer.CreateKey(int(characterId))
...
func ShowInfoCommandProvider(transactionId uuid.UUID, ch channel.Model, characterId uint32, path string) model.Provider[[]kafka.Message] {
	key := producer.CreateKey(int(characterId))
...
func ShowInfoTextCommandProvider(transactionId uuid.UUID, ch channel.Model, characterId uint32, text string) model.Provider[[]kafka.Message] {
	key := producer.CreateKey(int(characterId))
...
func UpdateAreaInfoCommandProvider(transactionId uuid.UUID, ch channel.Model, characterId uint32, area uint16, info string) model.Provider[[]kafka.Message] {
	key := producer.CreateKey(int(characterId))
...
func ShowGuideHintCommandProvider(transactionId uuid.UUID, ch channel.Model, characterId uint32, hintId uint32, duration uint32) model.Provider[[]kafka.Message] {
	key := producer.CreateKey(int(characterId))
...
func ShowIntroCommandProvider(transactionId uuid.UUID, ch channel.Model, characterId uint32, path string) model.Provider[[]kafka.Message] {
	key := producer.CreateKey(int(characterId))
