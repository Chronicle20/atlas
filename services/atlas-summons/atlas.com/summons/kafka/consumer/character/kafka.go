...
// (services/atlas-character/.../kafka/message/character/kafka.go). The summon
// despawn cascade only needs CharacterId from the envelope; bodies are decoded
// faithfully to avoid Kafka parse errors.
