...
const (
	envLeaderEnabled = "SUMMON_LEADER_ELECTION_ENABLED"
	envLeaderTTL     = "SUMMON_LEADER_TTL"
	envLeaderRefresh = "SUMMON_LEADER_REFRESH"
	envLeaderBackoff = "SUMMON_LEADER_BACKOFF"
