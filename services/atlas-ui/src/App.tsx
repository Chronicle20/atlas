...
const GachaponsPage = lazy(() =>
  import("@/pages/GachaponsPage").then((m) => ({ default: m.GachaponsPage })),
);
const GachaponDetailPage = lazy(() =>
  import("@/pages/GachaponDetailPage").then((m) => ({
    default: m.GachaponDetailPage,
  })),
);
const GuildsPage = lazy(() =>
  import("@/pages/GuildsPage").then((m) => ({ default: m.GuildsPage })),
);
const GuildDetailPage = lazy(() =>
