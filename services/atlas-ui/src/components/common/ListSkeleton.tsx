        ...
        <div key={`skeleton-item-${index}`} className={getItemClassName()}>
          ...
          {showAvatar && (
            <Skeleton
              variant="circular"
              animation={animation}
              className={cn(variant === "compact" ? "h-8 w-8" : "h-10 w-10")}
            />
          )}
          ...
          <div className="flex-1 space-y-2">
            ...
            <Skeleton
              animation={animation}
              className={cn("h-4", variant === "compact" ? "w-24" : "w-32")}
            />
            ...
            {showSubtext && (
              <Skeleton
                animation={animation}
                className={cn("h-3", variant === "compact" ? "w-16" : "w-48")}
              />
            )}
          </div>
          ...
          {showActions && (
            <div className="flex items-center space-x-2">
              <Skeleton
                animation={animation}
                className={cn(variant === "compact" ? "h-6 w-12" : "h-8 w-16")}
              />
              <Skeleton
                animation={animation}
                className={cn(variant === "compact" ? "h-6 w-6" : "h-8 w-8")}
              />
            </div>
          )}
        </div>
