...
export function ExpireBanDialog({
  ban,
  open,
  onOpenChange,
  tenant,
  onSuccess,
}: ExpireBanDialogProps) {
        ...
        <AlertDialogHeader>
          ...
          <AlertDialogDescription asChild>
            <div className="space-y-4">
              <p>
                Are you sure you want to expire this ban early? The player will
                be able to resume playing immediately.
              </p>
