...
export const getColumns = ({tenant, tenantConfig, accountMap, onRefresh}: ColumnProps): ColumnDef<Character>[] => {
    return [
        ...
        },
        {
            ...
            header: "Name",
            cell: ({row}) => (
                <Link to={"/characters/" + row.original.id} className="font-medium text-primary hover:underline">
        ...
        },
        {
            ...
            cell: ({row}) => {
                ...
                return (
                    <Link to={"/accounts/" + accountId} className="text-primary hover:underline">
