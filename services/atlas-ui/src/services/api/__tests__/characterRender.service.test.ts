...
describe("generateCharacterUrl", () => {
  it("builds the documented path/query shape", () => {
    ...
    expect(url.startsWith("/api/assets/tenant-a/GMS/83.1/character/")).toBe(
      true,
    );
  ...
  it("sorts items so order does not change the URL", () => {
    const a = generateCharacterUrl(
      ...
      1,
      {
        ...
        hair: 30030,
        face: 20000,
        equipment: { "-1": 1442024, "-11": 1002357, "-5": 1402024 },
      },
      {},
    );
    const b = generateCharacterUrl(
      "t",
      "GMS",
      83,
      1,
      {
        ...
        hair: 30030,
        face: 20000,
        equipment: { "-11": 1002357, "-5": 1402024, "-1": 1442024 },
      },
      {},
    );
    expect(a).toBe(b);
...
describe("canonicalLoadoutString gender", () => {
  it("appends resolved gender as the final field", () => {
    const c = canonicalLoadoutString(
      "T",
      "GMS",
      83,
      1,
...
describe("generateCharacterUrl gender", () => {
  ...
  it("male-face vs female-face empty loadout produce different hashes (no collision)", () => {
    const male = generateCharacterUrl(
      "t",
      "GMS",
      83,
      1,
    ...
    const female = generateCharacterUrl(
      "t",
      "GMS",
      83,
      1,
