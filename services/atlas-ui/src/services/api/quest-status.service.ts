...
export const questStatusService = {
  ...
  async getStartedQuests(
    ...
    return api.getList<CharacterQuestStatus>(
      `${BASE_PATH}/${characterId}/quests/started`,
      options,
    );
  },
  ...
  async getCompletedQuests(
    ...
    return api.getList<CharacterQuestStatus>(
      `${BASE_PATH}/${characterId}/quests/completed`,
      options,
    );
  },
  ...
  async getQuestStatus(
    ...
    return api.getOne<CharacterQuestStatus>(
      `${BASE_PATH}/${characterId}/quests/${questId}`,
      options,
    );
  },
  ...
  async hasStartedQuest(
    ...
    try {
      const status = await questStatusService.getQuestStatus(
        characterId,
        questId,
        options,
      );
  ...
  async forfeitQuest(
    ...
    await api.post<void>(
      `${BASE_PATH}/${characterId}/quests/${questId}/forfeit`,
      {},
      options,
    );
  },
