// Command outboxguardvet is the `go vet -vettool=` entry point for the
// outboxguard analyzer.
//
// It exists alongside cmd/outboxguard (a singlechecker driver) purely for
...
func main() {
	unitchecker.Main(outboxguard.Analyzer)
}
