// Command rediskeyguardvet is the `go vet -vettool=` entry point for the
// rediskeyguard analyzer.
//
// It exists alongside cmd/rediskeyguard (a singlechecker driver) purely for
...
func main() {
	unitchecker.Main(rediskeyguard.Analyzer)
}
